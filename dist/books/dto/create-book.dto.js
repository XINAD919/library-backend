...
class CreateBookDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { title: { required: true, type: () => String }, author: { required: true, type: () => String }, publicationDate: { required: false, type: () => Number, minimum: 1000, maximum: 2024 }, synopsis: { required: false, type: () => String }, publisher: { required: false, type: () => String }, genre: { required: false, type: () => String }, quantity: { required: false, type: () => Number } };
    }
}
